...
// Root page that serves the default locale (Chinese) content directly
// This handles the "/" path when using 'as-needed' locale prefix mode

export async function generateMetadata() {
  const t = await getTranslations({
    locale: 'zh', // Use default locale
    namespace: 'Index',
  });
              ...
              <div className="u-grid-desktop gap-8 lg:gap-16 items-center">
                <div className="lg:col-span-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Button variant="primary" size="lg" href="/zh/sign-up">
                      {t('get_started')}
                    </Button>
                    <Button variant="secondary" size="lg" href="/zh/dashboard">
                      {t('view_docs')}
                    </Button>
                  </div>
                </div>
